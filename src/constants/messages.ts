export const USERS_MESSAGES = {
  ...
  VERIFY_FORGOT_PASSWORD_TOKEN_SUCCESS: 'Verify forgot password token is successfully ',
  RESET_PASSWORD_SUCCESS: 'reset password is successfully',
  GET_ME_SUCCESS: 'Get profile is successfully',
  ...
  REFRESH_TOKEN_IS_SUCCESS: 'Refresh token successfully'
} as const
